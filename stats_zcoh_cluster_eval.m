...
for iLabel1=1:length(temporal)
    ...
    for iLabel2=1:length(frontal)
        ...
        load([sim_dir 'coherence/zcoh/stats_zcoh_' temporal{iLabel1} '_' frontal{iLabel2} '_'  ...
            '_nsubj' num2str(nsubj) '_noiser_' num2str(NoiseLevelr(1)) '_' num2str(NoiseLevelr(2)) '_'  tag '.mat']);
...
title('cond2>cond1-temporal-frontal Z-Coh')
...
figure;
imagesc(-sig_matrix_cond2_Allfreq);colormap('jet');axis xy;colorbar;set(gca,'fontsize',12,'fontweight','bold')
title('cond2>cond1-temporal-frontal Z-Coh')
%;set(gca,'clim',[-4000 4000])
