...
for iparts=3:3
    ...
    specific_tag=['templ_tempr_' num2str(sub_num) 'sub_jitter_15to20f_8subj_stg' num2str(parts(iparts)) 'parts'];
    ...
    for isnr=1:1
        ...
        SNR=snr(isnr);
             ...
             simulation_coh_func_2(sim_dir,label_names,all_label,all_label1,all_label2,label1,noiseLevelr,specific_tag,SNR,labeldir_tag,maxJitter,noiseLevel)
