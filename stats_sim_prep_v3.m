...
for icond=2:2
    ...
    coh_subj=zeros(nsubj,length(temporal),length(frontal),46,501);
    ...
    for isubj=1:nsubj
        ...
        filename=[sim_dir 'coherence/crossConn_subj_' num2str(isubj) '_' temporal{iLabel1}(1:end-6) '_' frontal{iLabel2}(1:end-6) '_cond' num2str(icond) '_noiserest' num2str(NoiseLevelr(icond)) ...
            '_jitter_noiseTempFront_' num2str(jitter_noise(1,1)) '_' num2str(jitter_noise(1,2)) '_' num2str(jitter_noise(2,1)) '_' num2str(jitter_noise(2,2)) '.mat'];
    ...
    save([sim_dir 'coherence/data_subj_crossConn_temporal_frontal_cond' num2str(icond) '_noiserest' num2str(NoiseLevelr(icond)) '_nsubj' ...
        num2str(nsubj) '_' num2str(jitter_noise(1,1)) num2str(jitter_noise(1,2)) num2str(jitter_noise(2,1)) num2str(jitter_noise(2,2)) '.mat'], ...
        'coh_subj','icoh_subj','time','freq','temporal','frontal')
    
    figure;
    imagesc(squeeze((mean(coh_subj(:,5,3,:,:)))));axis xy;colorbar
end
