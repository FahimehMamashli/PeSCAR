function do_sim_stats(sim_dir,temporal,frontal,X,noiseLevelr,specific_tag,flagrest,SNR)
...
for icond=1:2
    ...
    save([sim_dir 'coherence/stats/data_allsubj_coh_cond' num2str(icond) '_' tag '.mat'], ...
...
icond=1;
fcond1=[sim_dir 'coherence/stats/data_allsubj_coh_cond' num2str(icond) '_' tag1 '.mat'];
...
icond=2;
fcond2=[sim_dir 'coherence/stats/data_allsubj_coh_cond' num2str(icond) '_' tag2 '.mat'];
