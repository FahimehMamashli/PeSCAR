...
fcond1=[sim_dir 'coherence/data_subj_crossConn_temporal_frontal_cond' num2str(icond) '_noiserest' num2str(NoiseLevelr(icond)) '_nsubj' ...
...
icond=2;
jitter_noise=X{icond};
fcond2=[sim_dir 'coherence/data_subj_crossConn_temporal_frontal_cond' num2str(icond) '_noiserest' num2str(NoiseLevelr(icond)) '_nsubj' ...
        num2str(nsubj) '_' num2str(jitter_noise(1,1)) num2str(jitter_noise(1,2)) num2str(jitter_noise(2,1)) num2str(jitter_noise(2,2)) '.mat'];
cond2=load(fcond2);
...
for iLabel1=1:length(temporal)
    ...
    for iLabel2=1:length(frontal)
        ...
        save([sim_dir 'coherence/stats/stats_i-coh_' temporal{iLabel1} '_' frontal{iLabel2} '_noiserest' num2str(NoiseLevelr(1)) '_' num2str(NoiseLevelr(2))  ...
