...
for iparts=3:3
    ...
    specific_tag=['templ_tempr_discR_varsubj_' num2str(sub_num) 'sub_norand_15to20f_8subj_stg' num2str(parts(iparts)) 'parts'];
    ...
    for isnr=1:length(snr)
        ...
        %  [tag, FREQ, fs] = simulation_coh_func_norandom_clustercompar(sim_dir,label_names,label1,noiseLevelr,specific_tag,SNR,labeldir_tag,isspatial_var);
